...
seurat <- readRDS("/path/to/output/hiPSC_village_18_lines/iPSC_maintenance/QC/time-integrated_filtered_seurat_1pct_expressing.rds")



### Make DF for modeling ###
df_hier_unscale <- data.frame("Expression" = seurat[["SCT"]]@scale.data[gene,], "Line" = seurat@meta.data$AtLeastHalfSinglet_Individual_Assignment, "Passage" = as.factor(seurat@meta.data$Passage))
