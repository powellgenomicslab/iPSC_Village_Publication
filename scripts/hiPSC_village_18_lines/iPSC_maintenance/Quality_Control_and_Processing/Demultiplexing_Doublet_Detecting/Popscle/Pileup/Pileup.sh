...
# Author: Drew Neavin
# Date: 2022-10-03
# Description: This script is to run popscle pileup on the 18-line hiPSC village with Demuxafy (https://demultiplexing-doublet-detecting-docs.readthedocs.io/en/latest/). 
##############################################################################
...
singularity exec Demuxafy.sif popscle dsc-pileup --sam $BAM --vcf $VCF --group-list $BARCODES --out $OUT/$SAMPLE/pileup
