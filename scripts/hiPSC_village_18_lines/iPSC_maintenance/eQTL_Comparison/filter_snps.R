...
##### Set up variables #####
dir <- "/path/to/output/hiPSC_village_18_lines/iPSC_maintenance/eQTL_Comparison/"
...
resid_files <- list.files("/path/to/output/hiPSC_village_18_lines/iPSC_maintenance/output/Variance/gene_separated/residuals4qtl")
