...
indir_uni <- "/path/to/output/eQTL_Comparison/Cryopreserved/uni_village/uniculture/gene_separate/beds/"
indir_village <- "/path/to/output/eQTL_Comparison/Cryopreserved/uni_village/village/gene_separate/beds/"
outdir <- "/path/to/output/eQTL_Comparison/Cryopreserved/uni_village/combined/"


dir.create(outdir, recursive = TRUE)


### Read in results uni-culture ###
