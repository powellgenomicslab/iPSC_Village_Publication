...
DIR="/path/to/output/eQTL_Comparison/uni_village/Cryopreserved"
OUTDIR="$DIR/cryopreserved/village"

mkdir -p $OUTDIR

deboever_genes="$DIR/deboever_gene_snp_list.tsv"
variance_genes="/path/to/output/eQTL_Comparison/variance_partition_cryo/village/gene_separated/residuals4qtl"
