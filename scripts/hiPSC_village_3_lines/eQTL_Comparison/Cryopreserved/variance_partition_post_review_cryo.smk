...
rule partition_variance_uniculture:
    ...
    output:
        "/path/to/output/variance_partition_cryo/uniculture/gene_separated/icc/{gene}_icc.rds",
    resources:
    ...
    params:
        ...
        out_icc="/path/to/output/variance_partition_cryo/uniculture/gene_separated/icc/",
        out_model="/path/to/output/variance_partition_cryo/uniculture/gene_separated/fit_models/",
        out_resids="/path/to/output/variance_partition_cryo/uniculture/gene_separated/residuals4qtl/",
        out_icc_interaction = "/path/to/output/variance_partition_cryo/uniculture/gene_separated/icc_interaction/",
        out_model_interaction = "/path/to/output/variance_partition_cryo/uniculture/gene_separated/icc_interaction/"
    log:
    shell:
        """
...
rule partition_variance_village:
    ...
    output:
        "/path/to/output/variance_partition_cryo/village/gene_separated/icc/{gene}_icc.rds",
    resources:
        mem_per_thread_gb = lambda wildcards, attempt: attempt * 16,
        disk_per_thread_gb = lambda wildcards, attempt: attempt * 16
    threads: 4
    params:
        ...
        out_icc="/path/to/output/variance_partition_cryo/village/gene_separated/icc/",
        out_model="/path/to/output/variance_partition_cryo/village/gene_separated/fit_models/",
        out_resids="/path/to/output/variance_partition_cryo/village/gene_separated/residuals4qtl/",
        out_icc_interaction = "/path/to/output/variance_partition_cryo/village/gene_separated/icc_interaction/",
        out_model_interaction = "/path/to/output/variance_partition_cryo/village/gene_separated/icc_interaction/"
    log:
    shell:
        """
        mkdir -p {params.out_icc_interaction}
