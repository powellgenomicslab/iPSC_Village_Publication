...
deboever=/directflow/SCCGGroupShare/projects/DrewNeavin/References/iPSC_eQTLs/DeBoeveriPSCeQTLs.txt ## Downloaded from DeBoever et al publication (2017, Cell Stem Cell) and provided in the iPSC_Village_Publication github: https://github.com/powellgenomicslab/iPSC_Village_Publication
