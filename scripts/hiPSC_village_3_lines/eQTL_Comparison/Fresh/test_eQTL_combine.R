...
indir_uni <- "/path/to/output/eQTL_Comparison/Fresh/uni_village/Uni-culture/gene_separate/beds/"
indir_village <- "/path/to/output/eQTL_Comparison/Fresh/uni_village/village/gene_separate/beds/"
outdir <- "/path/to/output/eQTL_Comparison/Fresh/uni_village/combined/"
