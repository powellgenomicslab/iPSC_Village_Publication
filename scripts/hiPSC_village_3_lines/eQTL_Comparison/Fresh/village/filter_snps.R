...
##### Set up variables #####
dir <- "/path/to/output/eQTL_Comparison/Fresh/uni_village/"
...
#### Get the genotype calls as a dataframe ####
...
resid_files <- list.files("/path/to/output/eQTL_Comparison/variance_partition_fresh/village/gene_separated/residuals4qtl/")
