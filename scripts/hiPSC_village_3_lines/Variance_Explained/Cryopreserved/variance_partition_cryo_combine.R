...
##### Set up directories #####
icc_dir <- "/path/to/output/variance_partition_cryo/gene_separated/icc/"
icc_interaction_dir <- "/path/to/output/variance_partition_cryo/gene_separated/icc_interaction/"
outdir <- "/path/to/output/variance_partition_cryo/combined/"
